---
title: "Creare Pagine Online: Tutorial base su Git, Quarto, Github, Github pages"
...
Questa pagina web e questo blog sono stati creati con il sistema di publishing **Quarto** (anche *rmarkdown* va benissimo se si lavora principalmente con R), ma si tratta solo di una delle opzioni disponibili. Pagine HTML, PDF o altri tipi di documenti possono essere prodotti in molti modi diversi.  

Il presente tutorial dà per scontato che abbiate già un’idea di come creare i documenti che desiderate (con [r]markdown, Quarto o altro) e vi guida nei passaggi successivi in modo semplice, passo per passo e con screenshot, fino alla pubblicazione online tramite **GitHub Pages**. GitHub è uno strumento estremamente potente per tutti gli obiettivi citati sopra.  
...
<figure><img src="images/02-02-poweshell.png" alt="Windows PowerShell" style="width: 100%; height: auto;"><figcaption>Windows PowerShell / Terminale</figcaption></figure>
...
<figure><img src="images/02-02-poweshell-parametri.png" alt="powershell git" style="width: 100%; height: auto;"><figcaption>Configurazione di Git nel terminale</figcaption></figure>
...
<figure><img src="images/02-02-poweshell-parametri-verifica.png" alt="verifica powershell git" style="width: 100%; height: auto;"><figcaption>Verifica della configurazione di Git nel terminale</figcaption></figure>
...
<figure><img src="images/03-01-create-repo.png" alt="create repo github" style="width: 100%; height: auto;"><figcaption>Creazione di una nuova repository dal dashboard di GitHub</figcaption></figure>
...
<figure><img src="images/03-02-name-repo.png" alt="name repo github" style="width: 100%; height: auto;"><figcaption>Scelta del nome per la repository</figcaption></figure>

<figure><img src="images/03-03-confirm-repo.png" alt="confirm create repo github" style="width: 100%; height: auto;"><figcaption>Diamo conferma della creazione della repository su GitHub</figcaption></figure>
...
<figure><img src="images/04-01-copy-link-git.png" alt="copy link repo git" style="width: 100%; height: auto;"><figcaption>Copia del link della repo GitHub</figcaption></figure>
...
<figure><img src="images/02-01-clickdestro.png" alt="right click terminal" style="width: 100%; height: auto;"><figcaption>Apertura del terminale sul Desktop o nella cartella in cui vogliamo clonare la repo</figcaption></figure>
...
<figure><img src="images/04-02-git-clone.png" alt="cloning repo" style="width: 100%; height: auto;"><figcaption>Clonazione della repo in locale</figcaption></figure>
...
<figure><img src="images/04-03-cloned-repo.png" alt="cloned repo" style="width: 100%; height: auto;"><figcaption>La repo appena clonata in locale appare come una cartella</figcaption></figure>
...
<figure><img src="images/05-00-quarto-download.png" alt="quarto download" style="width: 100%; height: auto;"><figcaption>Download del file di installazione di Quarto</figcaption></figure>
...
<figure><img src="images/05-01-quarto-check.png" alt="quarto check" style="width: 100%; height: auto;"><figcaption>Verifica dell’installazione di Quarto</figcaption></figure>
...
<figure><img src="images/06-00-quarto-document.png" alt="quarto document" style="width: 100%; height: auto;"><figcaption>Creazione di un file Quarto (`.qmd`) da RStudio</figcaption></figure>
...
<figure><img src="images/06-01-qmd-render.png" alt="quarto document render" style="width: 100%; height: auto;"><figcaption>Render di un report Quarto</figcaption></figure>
...
<figure><img src="images/07-01-open-in-terminal.png" alt="open folder in terminal" style="width: 100%; height: auto;"><figcaption>Apertura della cartella/repository nel terminale</figcaption></figure>
...
<figure><img src="images/07-02-first-commit.png" alt="git first commit" style="width: 100%; height: auto;"><figcaption>Esecuzione di `add`, `commit` e `push` per inviare i file su GitHub</figcaption></figure>
...
<figure><img src="images/07-03-credenziali-git-github.png" alt="git github credentials" style="width: 100%; height: auto;"><figcaption>Possibile richiesta di autenticazione al primo push</figcaption></figure>
...
<figure><img src="images/07-04-pushed-materials.png" alt="github pushed" style="width: 100%; height: auto;"><figcaption>La repository GitHub ora contiene i materiali creati in locale</figcaption></figure>
...
<figure><img src="images/08-01-github-settings.png" alt="github settings" style="width: 100%; height: auto;"><figcaption>Apertura delle impostazioni della repository</figcaption></figure>

Scorriamo verso il basso fino alla sezione **Pages**:

<figure><img src="images/08-02-settings-pages.png" alt="github pages" style="width: 100%; height: auto;"><figcaption>Accesso alla sezione GitHub Pages</figcaption></figure>
...
<figure><img src="images/08-03-from-branch.png" alt="deploy from a branch - main" style="width: 100%; height: auto;"><figcaption>Impostazione: Deploy from a branch → main</figcaption></figure>
...
<figure><img src="images/08-04-site-is-live.png" alt="site is live" style="width: 100%; height: auto;"><figcaption>Conferma che il sito web è online</figcaption></figure>
...
<figure><img src="images/08-05-page-online.png" alt="home page online" style="width: 100%; height: auto;"><figcaption>Visualizzazione della home page pubblicata</figcaption></figure>
...
#### ⚠️ Nota importante per il lavoro collaborativo
...
Per tutto il resto, compresi temi avanzati, personalizzazioni grafiche, gestione di siti complessi e integrazioni con R, Python o bibliografie, si rimanda alla documentazione ufficiale:  
<a href="https://quarto.org/docs/guide/" target="_blank">Guida completa di Quarto</a>.
