---
title: "Creare Pagine Online: Tutorial base su Git, Github, Github pages, Quarto (per utenti Windows)"
...
Il tutorial è rivolto soprattutto a utenti **Windows**. Chi utilizza **Linux** o **macOS** può adattare facilmente i passaggi, chiedere aiuto all’AI oppure consultare altri tutorial specifici.

### Obiettivi del tutorial

- Installare e configurare **Git** su Windows.  
- Creare un account **GitHub** (useremo l’utente fittizio *Tizio Qualsiasi* con email *qualsiasitizio81@gmail.com*).  
...
Questo passaggio non è necessario se avete già un sistema per creare pagine HTML, ma lo presentiamo come opzione consigliata. In realtà, non è obbligatorio creare file HTML: dipende da cosa volete fare con Git e GitHub. Mostriamo comunque l’installazione di Quarto perché è particolarmente utile per diffondere pagine web in ottica Open Science e Terza Missione. Naturalmente, potreste usare GitHub anche solo per condividere dati, script o codice.
